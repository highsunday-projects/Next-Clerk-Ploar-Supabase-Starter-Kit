---
uuid: 9f63d7c7078e4b70be52e6ca4125725a
---
# 當前專案架構說明文件
...
│   │   │   ├── checkout/[plan]/route.ts   # Polar Checkout API
│   │   │   ├── customer-portal/route.ts   # Polar Customer Portal API
│   │   │   └── webhooks/
│   │   │       ├── clerk/route.ts         # Clerk Webhook 處理
│   │   │       └── polar/route.ts         # Polar Webhook 處理
│   │   ├── sign-in/              # 登入頁面
│   │   │   └── [[...sign-in]]/
│   │   │       └── page.tsx      # Clerk 登入組件
│   │   ├── sign-up/              # 註冊頁面
...
│   ├── Polar配置與準備說明.md    # Polar 付費系統配置指南
│   ├── Polar訂閱整合說明書.md    # Polar 整合技術說明
│   ├── database/                 # 資料庫相關檔案
│   │   └── polar_migration.sql   # Polar 資料庫遷移腳本
│   └── 功能/                     # 功能需求文檔
│       ├── B00-Bug修正模板.md
│       ├── F00-功能需求書模板.md
│       ├── R00-重構任務模板.md
...
- ✅ **user_profiles 資料表**: 完整的用戶訂閱資料結構（含 Polar 欄位）
...
- ✅ **安全性**: Clerk 企業級認證，Supabase RLS，路由保護
